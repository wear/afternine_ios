class Theme
  def self.customizeAppAppearance
    ...
    barButtonItemAppearance = UIBarButtonItem.appearance
    ...
    navTextColor = theme.navigationTextColor
    if (navTextColor) 
      titleTextAttributesNav[NSForegroundColorAttributeName] = navTextColor 
    end
    navTextShadowColor = theme.navigationTextShadowColor
    ...
    navTextFont = theme.navigationFont
    if (navTextFont) 
    ...
    titleTextAttributesBarButton = titleTextAttributesNav.mutableCopy
    barButtonTextFont = theme.barButtonFont
    ...
    baseTintColor = theme.baseTintColor
    if (baseTintColor) 
